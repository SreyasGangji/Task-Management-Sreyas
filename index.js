...
const htmlTaskContent = ({
  ...
  <div class="card shadow-sm task__card">
    <div
      class="card-header gap-2 d-flex justify-content-end task__card__header"
    >
      <button type="button" class="btn btn-outline-info " name=${id} onclick="editTask.apply(this, arguments)">
